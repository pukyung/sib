...
<div class="body">
	...
	<div id="content-title">
  	...
  	<!-- 판매자 정보 수정 폼 -->
	<form method="post" action="/project/modifySel.pj">
		<table>
			<tr>
				<td>사용자 이름</td>
				<td>${mypage.selname}</td>
			<tr>
			<tr>
				<td>id</td>
				<td>${mypage.selid}
					<input type="hidden" name="selid" value="${mypage.selid}"/>
				</td>
			<tr>
			<tr>
				<td>pw</td>
				<td>
					<input type="text" name="selpw" value="${mypage.selpw}" placeholder="${mypage.selpw}"/>
				</td>
			<tr>
			<tr>
				<td>담당자명</td>
				<td>
					<input type="text" name="repname" value="${mypage.repname}" placeholder="${mypage.repname}"/>
				</td>
			</tr>
			<tr>
				<td>전화번호</td>
				<td>
					<input type="text" name="selphone" value="${mypage.selphone}" placeholder="${mypage.selphone}"/>
				</td>
			</tr>
			<tr>
				<td>주소지</td>
				<td>
					<input type="text" name="seladdr" value="${mypage.seladdr}" placeholder="${mypage.seladdr}"/>
				</td>
			</tr>
		</table>
		<!-- 변경 결과 버튼 -->
